...
Vehicles = ['mountain bike','all-terrain bike','fire truck','garbage truck','pickup truck','tow truck','tow car','trailer truck','estate car','freight car',
'passenger car','race car','sports car','motor scooter','scooter','ambulance','jeep','rickshaw','ricksha','school bus','minibus','container ship','tractor','car','bike','truck','bus','bicycle']
...
def drawPred(classId, conf, left, top, right, bottom):
    ...
    if classes and (classes[classId] in  Vehicles):
